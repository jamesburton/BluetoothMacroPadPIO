...
#define PIN_TOUCH_RST -1 // Often not needed or shared with BL/Reset

#define TOUCH_I2C_ADDR 0x14 // Or 0x5D
#define TOUCH_I2C_PORT 0    // Wire (0) or Wire1 (1)
#define TOUCH_I2C_FREQ 400000

// --- Timing ---
// User specified: 11MHz
#define WRITE_FREQ_HZ     11000000

// Common ST7701S 480x480 Timings
...
// --- Init Sequence (Type 1 with 0xCD, 0x00) ---
static const uint8_t ST7701_INIT_SEQUENCE[] = {
    ...
    0xE7, 2, 0x44, 0x44,
    0xE8, 16, 0x09, 0xE8, 0xD8, 0xA0, 0x0B, 0xEA, 0xD8, 0x0A0, 0x0D, 0xEC, 0xD8, 0xA0, 0x0F, 0xEE, 0xD8, 0xA0,
